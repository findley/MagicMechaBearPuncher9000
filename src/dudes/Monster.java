...
import weapons.Bear;
import weapons.Coin;
import weapons.Diglet;
import weapons.Fireman;
...
public abstract class Monster extends Dude {
    ...
    public Weapon getDropWeapon(double dropRate) throws SlickException {
        Weapon[] lootItems = new Weapon[] { new Bear(pos[0], pos[1]), new Mecha(pos[0], pos[1]), new Diglet(pos[0], pos[1]),
                new Wizard(pos[0], pos[1]), new Fireman(pos[0], pos[1]) };
        float[] pos = this.pos;
