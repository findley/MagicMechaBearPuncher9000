...
public class Player {
	...
	public Player(float[] startWindowPos, float[] startWindowSize,
			HashMap<String, Integer> playerButtons, int playerNum) {
		...
		try {
			...
			this.down1 = new Image("Assets/players/player" + playerNum
					+ "/forwardWalk1.png");
			this.up1 = new Image("Assets/players/player" + playerNum
					+ "/backWalk1.png");
			this.right1 = new Image("Assets/players/player" + playerNum
					+ "/walkRight1.png");
			this.left1 = new Image("Assets/players/player" + playerNum
					+ "/walkLeft1.png");
			this.down2 = new Image("Assets/players/player" + playerNum
					+ "/forwardWalk2.png");
			this.up2 = new Image("Assets/players/player" + playerNum
					+ "/backWalk2.png");
			this.right2 = new Image("Assets/players/player" + playerNum
					+ "/walkRight2.png");
			this.left2 = new Image("Assets/players/player" + playerNum
					+ "/walkLeft2.png");
